...
Rails::Initializer.run do |config|
  ...
  config.plugins = %W(engines blacklight acts_as_taggable_on_steroids resource_controller haml fluid-infusion hydra_repository white_list marpa_courses_and_lectures)
