  ...
  module Datastreams
    class Paperclip < ActiveFedora::NokogiriDatastream
      ...
      set_terminology do |t|
        ...
        t.uploaded_file_name(:proxy=>[:file,:file_name])
        t.uploaded_content_type(:proxy=>[:file,:content_type])
        t.uploaded_file_size(:proxy=>[:file,:file_size])
        t.uploaded_updated_at(:proxy=>[:file,:file_updated_at])
      end
