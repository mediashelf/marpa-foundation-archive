...
describe RecordingInstantiationsController do
  ...
  describe "update" do
    it "should store uploaded filedata in S3" do
      ...
      xhr :post, :update, "utf8"=>"✓", "id"=>"recordinginstantiationf:nagarjuna1", "recording"=>"", "recording_instantiation"=>{"workflow_status"=>"collected", "duration"=>"", "location"=>"?", "iana_format"=>"audio/x-caf", "file_size_mb"=>"", "instantiation_identifier"=>"meow", "file"=>file_fixture, "informal_note"=>"", "technical_note"=>""}
