...
class HydrangeaBook < ActiveFedora::Base
  ...
  # Uses the Hydra MODS Book profile for tracking most of the descriptive metadata
  has_metadata :name => "descMetadata", :type => Hydra::ModsBook 
  ...
  # The value of the "release_to" entry in the properties datastream is used to decide who should be granted access to the book.
